                ...
                <div class="container-fluid">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-2 col-lg-2 col-md-1">
                            <div class="logo">
                                <h3 style="color: white;">Data Training</h3>
                            </div>
                        </div>
            ...
            <div class="container" align="center" style="padding-left: 100px;">
                ...
                <div class="footer-bottom" align="center">
                    <div class="row" align="center">
                        <div align="right" style="margin-left: 68%;margin-bottom: 10px;">
                            <a class="btn"href="tambah.php" align="right"> TAMBAH DATA</a>
                        </div>
                ...
                <thead>
                  ...
                  <tr>
                   ...
                   <tbody>
                        ...
                        ?>  <td><a class="btn-primary" href="edit.php?id=<?php echo $id_datas; ?>">edit</a></td>
                            <td><a class="btn-danger" href="delete.php?id=<?php echo $id_datas; ?>">delete</a></td></tr> <?php
