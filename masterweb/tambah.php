    ...
    <footer>
        ...
        <div align="left" valign="top" style="color: white;">
                    ...
                    <?php } ?>
                                ...
                                <div class="form-group" style="margin-right: 10px;">
                                <label>
                                    <input type="radio" value="<?php echo $i;?>" id="optionsRadios1" name="kerusakan">
            ...
            <div class="form-group">
                        <button type="submit" name="upload" value="Upload" class="button button-contactForm btn_1 boxed-btn">Input</button>
                     </div>
            </form>
        </section>
        <!-- Team End -->
